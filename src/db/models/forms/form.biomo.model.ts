...
sequelize.define('BIOMO_FORM_2', {
  ...
  fecha: DataTypes.STRING,
  editado: DataTypes.STRING,
  id_usuario: { type: DataTypes.INTEGER, allowNull: false, references: { model: 'users', key: 'id' }, onDelete: 'CASCADE' },
  image_url: { type: DataTypes.STRING(500), allowNull: true, defaultValue: null }
...
sequelize.define('BIOMO_FORM_5', {
  ...
  fecha: DataTypes.STRING,
  editado: DataTypes.STRING,
  id_usuario: { type: DataTypes.INTEGER, allowNull: true, references: { model: 'users', key: 'id' }, onDelete: 'CASCADE' },
  image_url: { type: DataTypes.STRING(500), allowNull: true, defaultValue: null }
